            ...
            <form id="loginForm" name="loginForm" ref="loginForm" action="#" method="post" class="form-group" v-on:submit="loginUser($event)">
                ...
                <p>
                    <span class="fieldBlock">
                        ...
                        <input readonly="readonly" id="user" type="text" class="form-control" ref="user" name="user" v-model="credentials.user" required v-on:blur="checkUser()">
                    </span>
...
=======
                    this.credentials.user = user;
                        this.checkUser()
>>>>>>> 12ebfe40375c0c2f5d969d27f47c17b51ff59f6c
                }
            },
