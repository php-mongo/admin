...
<template>
    <tr>
        <td class="info rb"><span class="pma-link" v-on:click="showDatabase">{{ db.name }}</span></td>
        <td class="info rb">{{ humanReadable(db.sizeOnDisk) }}</td>
        <td class="info rb text-center">{{ db.empty }}</td>
    </tr>
</template>
