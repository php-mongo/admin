<!--
  ...
  - @version      CollectionTransfer.vue 1002 3/8/21, 12:23 pm  Gilbert Rehling $
  - @package      PhpMongoAdmin\resources
  - @subpackage   CollectionTransfer.vue
...
<template>
    <transition name="slide-in-top">
        <div id="panel-modal-transfer" class="panel-modal" v-if="show" v-on:click="closeDialogOutside($event)">
    ...
    export default {
        ...
        methods: {
            ...
            closeDialogOutside( event ) {
                if ($(event.target).is('#panel-modal-transfer')) {
                    this.hideComponent();
                }
            }
        },
