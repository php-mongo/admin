<!--
  ...
  - @version      CollectionValidation.vue 1002 3/8/21, 12:23 pm  Gilbert Rehling $
  - @package      PhpMongoAdmin\resources
  - @subpackage   CollectionValidation.vue
...
<template>
    <transition name="slide-in-top">
        <div id="panel-modal-validation" class="panel-modal" v-if="show" v-on:click="closeDialogOutside($event)">
    ...
    export default {
        ...
        methods: {
            ...
            closeDialogOutside( event ) {
                if ($(event.target).is('#panel-modal-validation')) {
                    this.hideComponent();
                }
            }
        },
