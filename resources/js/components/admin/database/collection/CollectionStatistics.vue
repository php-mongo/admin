<!--
  ...
  - @version      CollectionStatistics.vue 1002 3/8/211, 12:23 pm  Gilbert Rehling $
  - @package      PhpMongoAdmin\resources
  - @subpackage   CollectionStatistics.vue
...
<template>
    <transition name="slide-in-top">
        <div id="panel-modal-statistics" class="panel-modal" v-if="show" v-on:click="closeDialogOutside($event)">
    ...
    export default {
        ...
        methods: {
            ...
            closeDialogOutside( event ) {
                if ($(event.target).is('#panel-modal-statistics')) {
                    this.hideComponent();
                }
            }
        },
