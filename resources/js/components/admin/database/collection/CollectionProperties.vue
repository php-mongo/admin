<!--
  ...
  - @version      CollectionProperties.vue 1002 2/8/21, 12:23 pm  Gilbert Rehling $
  - @package      PhpMongoAdmin\resources
  - @subpackage   CollectionProperties.vue
...
<template>
    <transition name="slide-in-top">
        <div id="panel-modal-properties" class="panel-modal" v-if="show" v-on:click="closeDialogOutside($event)">
    ...
    export default {
        ...
        methods: {
            ...
            closeDialogOutside( event ) {
                if ($(event.target).is('#panel-modal-properties')) {
                    this.hideComponent();
                }
            }
        },
